<xsl:stylesheet version="2.0" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions">
            ...
            <body>
                <table>
					<tbody>
                        <div class="news">
                            <ul>
                                <xsl:apply-templates select="/xhtml:html/xhtml:body/xhtml:table[4]/xhtml:tr/xhtml:td[5]/xhtml:table[6]/xhtml:tr/xhtml:td[3]/xhtml:table[3]/xhtml:tr">
                                </xsl:apply-templates>
                            </ul>
                        </div>
					</tbody>
    ...
    <xsl:template match="/xhtml:html/xhtml:body/xhtml:table[4]/xhtml:tr/xhtml:td[5]/xhtml:table[6]/xhtml:tr/xhtml:td[3]/xhtml:table[3]/xhtml:tr">
